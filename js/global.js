...
function goto(trans) {
	...
	switch (trans) {
		case 'setting_quanxian':
			location.href = "../../设置/setting/authority_setting.html";
			break;
		case 'setting_xinxi':
			location.href = "../../设置/setting/operator_information_maintenance.html";
			break;
		case 'setting_change':
			location.href = "../../设置/setting/operator_information_change.html";
			break;
		case 'setting_fuhe':
			location.href = "../../设置/setting/review_process_setting.html";
			break;
		case 'setting_xiane':
			location.href = "../../设置/setting/transaction_limit_setting.html";
			break;
		case 'setting_guide':
			location.href = "../../设置/系统设置向导/few_reviewA.html";
			break;
		case 'fh_quanxian':
			location.href = "../../设置/setting/admin_review_a.html";
			break;
	}
}
//首页弹出框
